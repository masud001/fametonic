...
<div
	class="announcement-bar font-figtree from-secondary to-primary flex w-full items-center justify-center gap-3 bg-gradient-to-r p-5 text-center md:py-2.5"
